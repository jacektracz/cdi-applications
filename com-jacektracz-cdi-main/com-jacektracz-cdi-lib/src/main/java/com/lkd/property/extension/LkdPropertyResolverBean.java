...
public class LkdPropertyResolverBean<R> {
    ...
    String sClass = "LkdPropertyResolverBean::";
    ...
    public LkdPropertyResolverBean(
        ...
        LkdLogger.logAnnotatedMethod(this.prMethod, sFun);

        this.beanManager = beanManager;

        LkdLogger.logBeanManager(this.beanManager, sFun);
    ...
    public void initializePropertyResolverBean() {
        ...
        Set<Bean<?>> beans = this.beanManager.getBeans(declaringBeansClass);
        ...
        LkdLogger.logJavaClass(declaringClass, sFun + "declaringClass");

        this.prInstance = this.beanManager.getReference(
    ...
    public void CollectInjectionPoints(
        ...
        for (final AnnotatedParameter<? super R> parameter : prMethod
            ...
            LkdLogger.writeToLog(sFun + "InjectionPoint:added::" );
    ...
    public String resolveProperty(
        ...
        // CDI container
        LkdLogger.writeToLog(sFun + "InjectionPoints__resolve__start::" );
        
        for (InjectionPoint parameter : this.prPoints) {              
        ...
        LkdLogger.writeToLog(sFun + "InjectionPoints__resolve_end::" );
        
        Method javaMethod = this.prMethod.getJavaMember();

        LkdLogger.writeToLog(sFun + "InjectionPoints__invoked__start::" );
        String sProperty =  (String) javaMethod.invoke(
                    this.prInstance
                    , parameters.toArray());
        
        LkdLogger.writeToLog(sFun + "InjectionPoints__invoked__end::" );
